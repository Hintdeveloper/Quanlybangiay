namespace _3_GUI.View
{
	partial class FrmSize
	{
		...
		private void InitializeComponent()
		{
			...
			// btn_Reset
			// 
			btn_Reset.Location = new Point(77, 165);
			...
			// btn_Xoa
			// 
			btn_Xoa.Location = new Point(77, 126);
			...
			// btn_Sua
			// 
			btn_Sua.Location = new Point(77, 83);
			...
			// btn_Them
			// 
			btn_Them.Location = new Point(77, 37);
			...
			// txt_TimKiem
			// 
			txt_TimKiem.Location = new Point(2, 262);
			...
			txt_TimKiem.DoubleClick += txt_TimKiem_DoubleClick;
			txt_TimKiem.Leave += txt_TimKiem_Leave;
			// 
			// dgrid_Size
			// 
			dgrid_Size.BackgroundColor = Color.SeaShell;
			dgrid_Size.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			dgrid_Size.Location = new Point(2, 295);
			dgrid_Size.Name = "dgrid_Size";
			dgrid_Size.RowHeadersWidth = 51;
			dgrid_Size.RowTemplate.Height = 29;
			dgrid_Size.Size = new Size(805, 155);
			dgrid_Size.TabIndex = 12;
